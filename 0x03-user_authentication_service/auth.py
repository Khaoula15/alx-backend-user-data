...
def _hash_password(password: str) -> str:
    """ It takes in a password string arguments and returns a string
        where The returned string is a salted hash of the input password,
...
class Auth:
    """Auth class that interact with the authentication database.
    """
    ...
    def register_user(self, email: str, password: str) -> User:
        """ taking the mandatory email and password strings arguments and
    ...
    def valid_login(self, email: str, password: str) -> bool:
        """ credentials validation,that returns a boolean """
        try:
            user = self._db.find_user_by(email=email)
        except NoResultFound:
            return False
